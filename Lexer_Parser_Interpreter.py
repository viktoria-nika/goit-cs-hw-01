...
class TokenType:
    ...
    PLUS = "PLUS"
    MINUS = "MINUS"
    MUL = "MUL" # Додано множення
    DIV = "DIV" # Додано ділення
    LPAREN = "LPAREN"  # Додано дужка відкриваюча
    RPAREN = "RPAREN"  # Додано дужка закриваюча
...
class Lexer:
    ...
    def get_next_token(self):
        ...
        while self.current_char is not None:
            ...
            if self.current_char == "*":
                self.advance()
                return Token(TokenType.MUL, "*") # Додано

            if self.current_char == "/":
                self.advance()
                return Token(TokenType.DIV, "/") # Додано

            if self.current_char == "(":
                self.advance()
                return Token(TokenType.LPAREN, "(") # Додано

            if self.current_char == ")":
                self.advance()
                return Token(TokenType.RPAREN, ")") # Додано
...
class Parser:
    ...
    def factor(self):
        #Парсер для 'факторів', включаючи числа та вирази в дужках
    ...
    def term(self):
        #Парсер для 'terms', включаючи множення та ділення
        node = self.factor()
